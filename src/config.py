...
class Settings(BaseSettings):
    ...
    oss_secrets_bucket: str = OSS_SECRETS_BUCKET
...
def load_secrets_from_oss() -> dict[str, str]:
    ...
    # Import OSS storage module (lazy import to avoid circular dependency)
...
def clear_secret_cache():
    ...
    global _secrets_cache, _master_key
    _secrets_cache = {}
    _master_key = None
    logger.info("Secret caches cleared")


def get_settings_with_secrets() -> Settings:
    """
